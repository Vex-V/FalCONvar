...
INTERNAL: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("ver2.embed.embedders.base", ("Embedder",)),
    ("ver2.embed.embedders.local", ("LocalEmbedder", "TextTooLong", "KNOWN")),
    ("ver2.embed.embedders", ("Embedder", "build", "available")),
    ("ver2.embed.index.base", ("Hit", "VectorIndex")),
    ("ver2.embed.index.qdrant", ("QdrantIndex",)),
    ("ver2.embed.index.pgvector", ("PgVectorIndex",)),
    ("ver2.embed.index.multi", ("MultiIndex",)),
    ("ver2.embed.index", ("Hit", "MultiIndex", "QdrantIndex", "PgVectorIndex",
