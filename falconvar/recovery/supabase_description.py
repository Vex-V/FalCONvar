...
library -- ``urllib`` is enough to call PostgREST.
    ...
    python -m falconvar.recovery.supabase_description --list
    python -m falconvar.recovery.supabase_description test1
    python -m falconvar.recovery.supabase_description test1 --out descriptions.json
