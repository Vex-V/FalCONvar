...
directly and never touches this file.
    ...
    python -m falconvar.recovery.supabase_manifest test2
    python -m falconvar.recovery.supabase_manifest test2 --out manifests/test2.json
    python -m falconvar.recovery.supabase_manifest --list
    python -m falconvar.recovery.recreate test2.json --out rebuilt/
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    if not document.get("complete"):
        ...
        how = ("python -m falconvar.recovery.recreate" if __package__
