...
# with `falconvar.` is imported absolutely; anything else is relative to here.
_LAZY: dict[str, str] = {
    "openai": "falconvar.video.describe.vlm.openai_client:OpenAIDescriber",
}
...
def _resolve(name: str) -> Type:
    ...
    module = (importlib.import_module(module_name) if module_name.startswith("falconvar.")
