...
from falconvar.video.ingest.pipeline import Result, ingest
from falconvar.video.ingest.samplers import Sampler
from falconvar.video.ingest.source import UnusableSource
...
def main() -> int:
    ...
    if args.target_rate is not None:
        from falconvar.video.ingest.calibrate import calibrate as run_calibration
